...
public class SeleniumOperations {
	...
	public static void open_chrome_loadpage_resize_close() {
	    ...
	    System.out.println("Hello from 223068381, Nishant Khamkar");
	    ...
	    options.addArguments("--remote-allow-origins=*"); // Fix potential security issues
	    options.addArguments("--disable-blink-features=AutomationControlled"); 
	    options.setHeadless(false);

	    // Step 3: Use ChromeDriver with options
